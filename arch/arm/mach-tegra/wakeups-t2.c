...
static struct tegra_wake_info tegra_wake_event_data_t2[] = {
	...
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PN5), POLARITY_NONE}, // WAR for HOOK LP1 wake
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PG0), POLARITY_NONE}, // LP1 wake : Volume Key Up
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PG1), POLARITY_NONE}, // LP1 wake : Volume Key Down
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PG3), POLARITY_NONE}, // LP1 wake : HP DET
#else
#if (defined(CONFIG_MACH_STAR_P990) || defined(CONFIG_MACH_STAR_P999))
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PW2), POLARITY_NONE}, // WAR for PROX LP1 wake
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PG3), POLARITY_NONE}, // WAR for HP DET LP1 wake
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PD3), POLARITY_NONE}, // WAR for HOOK LP1 wake

...
#ifndef	BOARD_STAR_BASEBAND_H
#define	BOARD_STAR_BASEBAND_H
...
#define	BOARD_STAR_BASEBAND_U3XX		0
#define	BOARD_STAR_BASEBAND_N731		1
#define	BOARD_STAR_BASEBAND_SPI_LOOPBACK	2
#define	BOARD_STAR_BASEBAND_HSIC		3

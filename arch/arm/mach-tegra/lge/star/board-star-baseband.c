...
unsigned long baseband_type = BOARD_STAR_BASEBAND_U3XX;
...
static struct whistler_baseband whistler_baseband[] = {
	...
	[BOARD_STAR_BASEBAND_SPI_LOOPBACK] = {
